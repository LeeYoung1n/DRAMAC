...
//import com.dramac.service.ClipService;
//
//@Controller
...
//	public ModelAndView createForm(ClipService cs, HttpServletRequest req) {
...
//		MultipartFile posterMF = cs.getPosterMF();
//		
...
//		MultipartFile filenameMF=cs.getFilenameMF();
//		String filename=UploadSaveManager.saveFileSpring30(filenameMF, basePath);
//		cs.setFilename(filename);
//		cs.setFilesize(filenameMF.getSize());
////-------------------------------------------------------------------------------------------------------
//		int cnt=cm.create(cs);
//		if(cnt==0) {
